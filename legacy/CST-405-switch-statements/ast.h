...
/* Switch / case / break nodes */
ASTNode* createSwitch(ASTNode* expr, ASTNode* cases);           /* Create switch statement */
ASTNode* createCase(int value, int isDefault, ASTNode* body);   /* Create case/default clause */
ASTNode* createBreak();                                         /* Create break statement */
